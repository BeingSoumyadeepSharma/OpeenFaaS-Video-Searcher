        ...
        \begin{column}{0.48\textwidth}
            \begin{figure}
                ...
                \begin{tikzpicture}
                    ...
                    \addplot coordinates {(5,1521) (10,1669) (15,2028)};
                    \end{axis}
                \end{tikzpicture}
...
\begin{frame}{Dashboard Analytics: JMeter Load Profile (5 Users)}
    \begin{columns}
        \begin{column}{0.48\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=\textwidth,keepaspectratio]{images/jmeter_threads_5.png}
                \caption{JMeter Active Threads Over Time.}
            \end{figure}
        \end{column}
        \begin{column}{0.48\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=\textwidth,keepaspectratio]{images/jmeter_resp_time_5.png}
                \caption{JMeter Average Response Time Over Time.}
            \end{figure}
        \end{column}
    \end{columns}
\end{frame}

\begin{frame}{Dashboard Analytics: JMeter Load Profile (10 Users)}
    \begin{columns}
        \begin{column}{0.48\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=\textwidth,keepaspectratio]{images/jmeter_threads_10.png}
                \caption{JMeter Active Threads Over Time.}
            \end{figure}
        \end{column}
        \begin{column}{0.48\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=\textwidth,keepaspectratio]{images/jmeter_resp_time_10.png}
                \caption{JMeter Average Response Time Over Time.}
            \end{figure}
        \end{column}
    \end{columns}
...
\begin{frame}{Dashboard Analytics: JMeter Load Profile (15 Users)}
    \begin{columns}
        \begin{column}{0.48\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=\textwidth,keepaspectratio]{images/jmeter_threads_15.png}
                \caption{JMeter Active Threads Over Time.}
            \end{figure}
        \end{column}
        \begin{column}{0.48\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=\textwidth,keepaspectratio]{images/jmeter_resp_time_15.png}
                \caption{JMeter Average Response Time Over Time.}
            \end{figure}
        \end{column}
    \end{columns}
    ...
    \begin{columns}
        \begin{column}{0.48\textwidth}
            ...
            \begin{itemize}[<+->]
                ...
                \item Handled all requests successfully with 0 failures under peak load.
            \end{itemize}
        \end{column}
        \begin{column}{0.48\textwidth}
            \begin{figure}
                ...
                \begin{tikzpicture}
                    ...
                    \addplot coordinates {(5,1494) (10,1632) (15,2280)};
                    \end{axis}
                \end{tikzpicture}
...
\begin{frame}{Dashboard Analytics: Locust Workload (5 Users)}
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth,height=0.7\textheight,keepaspectratio]{images/locust_ec2_results_5.png}
        \caption{Locust Load Testing Results.}
    \end{figure}
\end{frame}

\begin{frame}{Dashboard Analytics: Locust Workload (10 Users)}
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth,height=0.7\textheight,keepaspectratio]{images/locust_ec2_results_10.png}
        \caption{Locust Load Testing Results.}
    \end{figure}
\end{frame}

\begin{frame}{Dashboard Analytics: Locust Workload (15 Users)}
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth,height=0.7\textheight,keepaspectratio]{images/locust_ec2_results_15.png}
        \caption{Locust Load Testing Results.}
    \end{figure}
\end{frame}
